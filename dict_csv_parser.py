...
def dict_parser():
    ...
    if len(sys.argv) > 1:
        ...
        with open(filename, 'r', encoding='utf8') as f:
            ...
            with open(os.path.join(fpath, fname), 'w', encoding='utf8', newline="") as new_users_table:
                ...
                for row in csv_reader:
                    # Loop through the csv_reader object and return only fields that contain personal identifiable information (PII) and write those fields to the new file. Ignore duplicate columns and rows. Don't write empty rows.
