    ...
    if len(sys.argv) > 1:
        ...
        for filename in os.listdir(sys.argv[1]):
            if filename.endswith(".csv"):
                ...
                # create a new folder named 'cleaned' in the same directory as the files to be parsed and save the parsed files there
                ...
                # fname = Path(filename).parent / fname
                # get the file path of the file to be parsed and open it
