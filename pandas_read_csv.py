...
def pandas_read_csv():
    ...
    not_pii = [
        ...
        'manageedit-shop_subscriptioncolumnshidden', 'managetoplevel_page_wp_streamcolumnshidden',
        'meta-box-order_carts, meta-box - order_wc_user_membership',
        'metaboxhidden_dt360_showcase, metaboxhidden_elementor_library', 'metaboxhidden_sfwd - lessons, metaboxhidden_shop_coupon',
